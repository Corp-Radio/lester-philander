...
const Navbar = () => {
      ...
      <div className="px-[5%] py-4">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 lg:w-15 lg:h-15 border border-white flex items-center justify-center">
  ...
  <a 
    href="mailto:info@lesterphilander.com"
  ...
  <a 
    href="tel:+27987654333"
    className="flex items-center gap-2 hover:text-white transition-colors duration-300"
  >
    <Phone size={14} className="text-white/60" />
    <span>+27 98 765 4333</span>
  </a>
</div>
                </div>
              </div>
              ...
              <ul className="hidden py-2 lg:flex xl:gap-8 lg:gap-8 items-center">
                ...
                <li>
                  <a
                    href="https://corpradio.online" target="_blank" rel="noopener noreferrer"
                    className="text-white text-xs tracking-[1.5px] hover:text-gray-300 transition-colors duration-300 font-medium"
                  >
...
const Testimonials = () => {
  ...
  return (
    <section id='testimonials' className="bg-gray-100 px-[5%] py-16 md:py-24">
  ...
  return (
    <section id="consulting" className="bg-white px-[5%] py-16 md:py-24 flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
      <div className="flex-1 w-full">
        ...
        <p className="text-gray-700 mb-4 mt-6 text-sm">Reach out via phone, WhatsApp, or email</p>
            <div className="space-y-3 ml-5">
              <a
                href="tel:+27987654333"
                className="flex items-center mb-1 gap-2 text-xs hover:text-gray-700 transition-colors duration-300 group"
              >
                <Phone size={16} className="text-gray-700 group-hover:text-gray-700" />
                <span>+27 98 765 4333</span>
              </a>

              <a
                href="https://wa.me/27987654333"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center mb-1 gap-2 text-xs hover:text-gray-700 transition-colors duration-300 group"
              >
                <svg className="w-4 h-4 text-gray-700 group-hover:text-gray-700" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                className="flex items-center mb-1 gap-2 text-xs hover:text-gray-700 transition-colors duration-300 group"
              >
                <Mail size={16} className="text-gray-700 group-hover:text-gray-700" />
                <span>info@lesterphilander.com</span>
              </a>
            </div>

            <p className="text-xs mt-1 ml-5 flex items-center gap-2">
...
const Footer = () => {
  ...
  const socialLinks = [
    { label: 'LINKEDIN', href: '#', target: "_blank", rel: "noopener noreferrer" },
    { label: 'INSTAGRAM', href: '#', target: "_blank", rel: "noopener noreferrer" },
    { label: 'YOUTUBE', href: '#', target: "_blank", rel: "noopener noreferrer" },
    { label: 'CORP RADIO', href: 'https://corpradio.online', target: "_blank", rel: "noopener noreferrer" },
  ];

  return (
    <footer id='footer' className="bg-[#0B1F3B] text-[#BFC3C9] px-[5%] py-12">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-8">
          <div>
            ...
            <p className="text-white/90 mb-4 text-sm">Reach out via phone, WhatsApp, or email</p>
